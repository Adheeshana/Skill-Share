    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          {/* Centered Skill Share logo/brand */}
          <div className="absolute left-0 right-0 mx-auto flex justify-center items-center h-16 pointer-events-none">
            <Link className="flex items-center font-bold text-2xl group pointer-events-auto" to="/">
              ...
              <span className="relative">
                <span className="transition-all duration-300 font-bold">SKILL</span>
                <span className={`font-bold ${scrolled ? 'text-blue-600' : 'text-blue-200'}`}>SHARE</span>
                {/* Simple underline */}
          ...
          {/* Desktop menu positioned on left and right sides of centered logo */}
          <div className="hidden sm:flex sm:items-center sm:justify-start flex-1">
            <div className="flex space-x-1">
              ...
              {searchOpen && (
                <div className="absolute top-full left-0 mt-1 w-full bg-white shadow-xl rounded-b-lg p-3 transform z-50">
